...
// just the normal Textfield, but we pass in a Globalkey

class _TextFieldSelectionGestureDetectorBuilder
    extends TextSelectionGestureDetectorBuilder {
  _TextFieldSelectionGestureDetectorBuilder({
    required _MeloTextFieldState state,
  })  : _state = state,
        super(delegate: state);

  final _MeloTextFieldState _state;
...
class MeloTextField extends StatefulWidget {
  ...
  final GlobalKey<EditableTextState> editingKey;
  ...
  @override
  State<MeloTextField> createState() => _MeloTextFieldState();
...
class _MeloTextFieldState extends State<MeloTextField>
  ...
  void initState() {
    super.initState();
    editableTextKey = widget.editingKey;
    _selectionGestureDetectorBuilder =
  ...
  @override
  void didUpdateWidget(MeloTextField oldWidget) {
